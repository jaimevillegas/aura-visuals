...
export const VISUALIZER_CONFIGS: Record<string, VisualizerParameter[]> = {
  kaleidoscope: [
    { name: 'segments', label: 'Segments', min: 4, max: 12, step: 1, defaultValue: 7, category: 'visual' },
    { name: 'rayCount', label: 'Ray Count', min: 20, max: 80, step: 10, defaultValue: 30, category: 'visual' },
    { name: 'rayLength', label: 'Ray Length', min: 0.3, max: 1.0, step: 0.05, defaultValue: 0.8, category: 'visual' },
    { name: 'rotationSpeed', label: 'Rotation Speed', min: 0, max: 2, step: 0.1, defaultValue: 0.3, category: 'motion' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 1.6, category: 'audio' },
  ],
  bars2d: [
    { name: 'barCount', label: 'Bar Count', min: 32, max: 256, step: 16, defaultValue: 112, category: 'visual' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 2.2, category: 'audio' },
    { name: 'barSpacing', label: 'Bar Spacing', min: 0, max: 1, step: 0.05, defaultValue: 0, category: 'visual' },
    { name: 'smoothing', label: 'Smoothing', min: 0, max: 1, step: 0.05, defaultValue: 0.2, category: 'visual' },
  ],
  particlecircle: [
    { name: 'particleCount', label: 'Particle Count', min: 50, max: 300, step: 10, defaultValue: 230, category: 'visual' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 2.5, category: 'audio' },
    { name: 'particleSize', label: 'Particle Size', min: 0.5, max: 3.0, step: 0.1, defaultValue: 1.3, category: 'visual' },
    { name: 'rotationSpeed', label: 'Rotation Speed', min: 0, max: 2, step: 0.1, defaultValue: 1.5, category: 'motion' },
  ],
  spiralwaves: [
    { name: 'spiralCount', label: 'Spiral Arms', min: 2, max: 12, step: 1, defaultValue: 4, category: 'visual' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 2.7, category: 'audio' },
    { name: 'rotationSpeed', label: 'Rotation Speed', min: 0, max: 2, step: 0.1, defaultValue: 1.8, category: 'motion' },
    { name: 'waveAmplitude', label: 'Wave Amplitude', min: 0.3, max: 2.0, step: 0.1, defaultValue: 1.7, category: 'visual' },
  ],
  circularwaveform: [
    { name: 'radius', label: 'Circle Radius', min: 50, max: 300, step: 10, defaultValue: 170, category: 'visual' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 2.7, category: 'audio' },
    { name: 'lineThickness', label: 'Line Thickness', min: 1, max: 10, step: 0.5, defaultValue: 5, category: 'visual' },
  ],
  symmetrymirror: [
    { name: 'mirrorAxes', label: 'Mirror Axes', min: 1, max: 6, step: 1, defaultValue: 6, category: 'visual' },
    { name: 'waveScale', label: 'Wave Scale', min: 50, max: 300, step: 10, defaultValue: 260, category: 'visual' },
    { name: 'sensitivity', label: 'Audio Sensitivity', min: 0.1, max: 3.0, step: 0.1, defaultValue: 3.0, category: 'audio' },
    { name: 'lineThickness', label: 'Line Thickness', min: 1, max: 5, step: 0.5, defaultValue: 3, category: 'visual' },
  ],
  geometricmandala: [
